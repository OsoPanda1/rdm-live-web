...
export function buildCommerceStateTopic(commerceId: string): string { return `ldtocs/comercio/${commerceId}/state`; }
export function buildSensorTelemetryTopic(sensorId: string): string { return `ldtocs/sensor/${sensorId}/telemetry`; }
export function buildSensorStateTopic(sensorId: string): string { return `ldtocs/sensor/${sensorId}/state`; }
export function buildTerritorySecurityTopic(): string { return "ldtocs/territory/events/security"; }
